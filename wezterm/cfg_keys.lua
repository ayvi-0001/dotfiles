...
function M.apply_to_config(config)
  ...
  config.key_tables = {
    ...
    resize_window = {
      ...
      { key = "H", mods = "NONE", action = wezterm.action.EmitEvent "decrease-from-left" },
      { key = "j", mods = "NONE", action = wezterm.action.EmitEvent "increase-to-bottom" },
      { key = "J", mods = "NONE", action = wezterm.action.EmitEvent "decrease-from-bottom" },
      { key = "k", mods = "NONE", action = wezterm.action.EmitEvent "increase-to-top" },
      { key = "K", mods = "NONE", action = wezterm.action.EmitEvent "decrease-from-top" },
      { key = "l", mods = "NONE", action = wezterm.action.EmitEvent "increase-to-right" },
      { key = "L", mods = "NONE", action = wezterm.action.EmitEvent "decrease-from-right" },
      { key = "Escape", mods = "NONE", action = "PopKeyTable" },
    },
    ...
    yazi_helix = {
      ...
      { key = "R", mods = "NONE", action = wezterm.action.EmitEvent "yazi-helix-open-new-right-pane-top-level" },
      { key = "d", mods = "NONE", action = wezterm.action.EmitEvent "yazi-helix-open-new-bottom-pane" },
      { key = "D", mods = "NONE", action = wezterm.action.EmitEvent "yazi-helix-open-new-bottom-pane-top-level" },
      ...
      { key = "S", mods = "NONE", action = wezterm.action.EmitEvent "trigger-hx-with-scrollback" },
      { key = "Escape", mods = "NONE", action = "PopKeyTable" },
    },
    ...
    pane = {
      ...
      { key = "D", mods = "NONE", action = wezterm.action.SplitPane { direction = "Down", top_level = true } },
      ...
      { key = "e", mods = "NONE", action = wezterm.action_callback(callbacks.move_pane_to_new_window) },
    ...
    copy_mode = {
      ...
      { key = "t", mods = "CTRL", action = wezterm.action.CopyMode "MoveToViewportTop" },
      { key = "b", mods = "CTRL", action = wezterm.action.CopyMode "MoveToViewportBottom" },
      { key = "m", mods = "CTRL", action = wezterm.action.CopyMode "MoveToViewportMiddle" },
