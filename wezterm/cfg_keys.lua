...
function M.apply_to_config(config)
  ...
  config.keys = {
    ...
    { key = "+", mods = "CTRL|SHIFT", action = wezterm.action_callback(callbacks.zoom_in) },
    { key = "-", mods = "CTRL", action = wezterm.action_callback(callbacks.zoom_out) },
    { key = "0", mods = "CTRL", action = wezterm.action_callback(callbacks.zoom_reset) },
